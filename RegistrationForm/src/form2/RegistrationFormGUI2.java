...
/**
 *
 * @admno: BSE-05-0238/2023
 * @Name: Eli Keli Muthoka
 */

// Creates a main class extending JFrame 
public class RegistrationFormGUI2 extends javax.swing.JFrame {
    ...
    public RegistrationFormGUI2() {
        ...
        // Set the table model for the RegistrationFormGUI2Tbl
        RegistrationFormGUI2Tbl.setModel(tableModel);
    ...
    private void initComponents() {
        ...
        setTitle("BSE-05-0238/2023 Eli Keli Muthoka");
    ...
    private void loadDataFromDatabase() {
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD); Statement stmt = conn.createStatement(); ResultSet rs = stmt.executeQuery("SELECT * FROM RegistrationFormGUI2")) {
    ...
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerBtnActionPerformed
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD); PreparedStatement stmt = conn.prepareStatement(
                "INSERT INTO RegistrationFormGUI2 (id, name, gender, contact, address) VALUES (?, ?, ?, ?, ?)")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrationFormGUI2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrationFormGUI2().setVisible(true);
            }
        });
    }
