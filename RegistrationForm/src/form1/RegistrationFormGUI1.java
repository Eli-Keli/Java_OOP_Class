...
public class RegistrationFormGUI1 extends javax.swing.JFrame {
    ...
    // Create constructor for RegistrationFormGUI1
    public RegistrationFormGUI1() {
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBtnActionPerformed
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD); PreparedStatement stmt = conn.prepareStatement(
                "INSERT INTO RegistrationFormGUI1 (name, mobile, gender, dob, address, terms) VALUES (?, ?, ?, ?, ?, ?)")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrationFormGUI1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrationFormGUI1().setVisible(true);
            }
        });
    }
